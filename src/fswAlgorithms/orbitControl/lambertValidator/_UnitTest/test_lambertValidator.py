...
def test_lambertValidator(show_plots, p1_dv, p2_tm, p3_tf, p4_iter, p5_errX, accuracy):
    ...
    **Test Parameters**
    ...
    Args:
        ...
        :param p1_dv: Delta-V vector
        :param p2_tm: maneuver time
        :param p3_tf: final time
        :param p4_iter: number of iterations of the Lambert solver root finder
        :param p5_errX: error of the Lambert solver root finder solution
...
def lambertValidatorTestFunction(show_plots, p1_dv, p2_tm, p3_tf, p4_iter, p5_errX, accuracy):
    ...
    lambertSolutionInMsgData.v1 = v1_BN_N + dv_N
    ...
    np.testing.assert_allclose(dv,
                               ...
                               rtol=0,
                               atol=accuracy,
                               err_msg=('Variable: dv,' + paramsString),
                               verbose=True)
