...
def test_lambertPlanner(show_plots, p1_revs, p2_tm, p3_tf, p4_eccs, accuracy):
    ...
    **Test Parameters**
    ...
    Args:
        ...
        :param p1_revs: number of revolutions to be completed
        :param p2_tm: maneuver time
        :param p3_tf: final time
        :param p4_eccs: eccentricity of orbit

    **Description of Variables Being Tested**

    The content of the LambertProblemMsg output message is compared with the true values. Most of the message content
    corresponds to the module input variables. The position vector r1vec of the message is obtained by integrating two
